...
try {
 ...
 assert.ok(html.includes('project_create')); assert.ok(html.includes('createProjectManager'));
 ...
 console.log(JSON.stringify({projectTools:true,version,installed,matchingFiles:files.length,installedMcpResource:true,htmlCharacters:html.length,actualCodexHostReloaded:false}));
