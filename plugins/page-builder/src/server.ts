...
server.registerTool("project_open", { title: "打开本地项目", description: "Open and validate a local Page Builder project folder, including a repository already cloned using Git. Returns workspaceId required by page tools.", inputSchema: { directory: z.string() } }, input => handle(() => projects.open(input.directory)));
